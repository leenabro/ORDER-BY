...
<!--             </li> -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">차종 정보 수정</h1>
            ...
            <div class="outer">
                <div id="joinInfoArea">
                   ...
                   method="post" onsubmit="return validate();">
                      ...
                      <h6>* 차종</h6>
                      <select name="insert_category" class="input_area" id="modify_product">
                    ...
                    <select name="sale_product_check" class="input_area" id="sale_product_id">
                      ...
                      <div class="btnArea">
                        <button id="joinBtn">차종 수정</button>
                        <button id="joinBtn">차종 삭제</button>
            ...
            <script>
              ...
              $('#modify_product').change(function() {
                var result = $('#modify_product option:selected').val();
                if (result == 'car') {
