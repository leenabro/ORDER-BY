		...
		<div class="wrap">
			<div class="notice_area">
				<div class="notice_title">
					<br><br><h1 class="main1">공지사항 작성</h1>
				</div>
				<div class="notice_content">
					...
					<input type="hidden" >
						<div class="content">
							...
							<span class="input_area"> <input type="text" name="n_title" 
								required>
							</span>
							
							<h4>
								<span class="title_span">&nbsp;</span> 첨부파일
							</h4>
							<span class="input_area"> <input type="file" name="upfile" 
								>
							</span>
