		...
		<form action="${ path }/enroll" name="signupForm" id="signupForm" method="POST" onsubmit="return checkAll();">
			<fieldset style="border: none; margin: 0; padding: 0;">
	            <div class="mainEnroll">
		            <section class="signupWrap">
						...
						<form action="" name="signupForm" id="signupForm" method="POST" onsubmit="">
							<fieldset style="border: none; margin: 0; padding: 0;">
			                    <!-- 아이디 -->
				                <div>
				                    <h3>아이디</h3>
			...
			<!-- 			                        </span> -->
				                    ...
				                    <label for="memberPwd1" class="lockBox">
				                        ...
				                        <input name="memberPwd1" id="memberPwd1" type="password" style="ime-mode:disabled" autocomplete="off" min="8" max="16" placeholder="비밀번호 입력" oninput="memberPwd1ch()" required autofocus />
				                        <!-- <span class="pwdLock"> -->
				                    ...
				                    <label for="memberPwd2" class="lockBox">
				                        <input name="memberPwd2" id="memberPwd2" type="password" style="ime-mode:disabled" autocomplete="off" maxlength="16" placeholder="비밀번호 재확인" oninput="memberPwd2ch()" required autofocus />
				                    </label>
			                        <!-- 조건 3개 -->
			                        <!--focus 시 텍스트 -->
									...
									<form action="${ path }/auth" method="POST">
								        <fieldset style="border: none; margin: 0; padding: 0;">
								            <label for="memberEmail" class="memberEmail">
								                <input name="memberEmail" id="memberEmail" type="text" style="ime-mode:disabled" autocomplete="on" placeholder="이메일 입력" title="이메일을 입력하세요." required autofocus />
								            ...
								            <label for="memberCnum" class="memberCnum">
						                        <input name="memberCnum" id="memberCnum" type="text" placeholder="인증번호를 입력하세요." title="인증번호를 입력하세요." required />
